...
class Triangle implements IShape{          // not public so only ShapeFactory can return shapes
	...
	public Triangle (Point start, Point end, ShapeColor primaryColor, ShapeColor secondaryColor, 
		...
		this.shapeType = shapeType;                  // not passing this in, should be obvious it's a triangle right?
	}
